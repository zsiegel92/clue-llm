...
<div className="rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-800/50 px-5 py-4 text-center italic text-lg">
```
...
<u>We carefully selected attributes that consist of a single token. All the names, places, materials, foods, etc. consist of ONE token.</u>
