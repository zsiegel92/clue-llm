...
We went in with five hypotheses. Here's what happened:
...
**4. Confidently-wrong cases beat unconfidently-wrong cases: FALSE (negligible effect)**

Most-confident-wrong (96.8%) vs. least-confident-wrong (96.4%)—a 0.4% difference. This was our most interesting hypothesis, and it was wrong. Whether the model is confidently or hesitantly incorrect doesn't seem to matter much for fine-tuning effectiveness.
